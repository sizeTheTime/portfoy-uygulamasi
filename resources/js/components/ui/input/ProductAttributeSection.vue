      ...
      <div class="flex items-center justify-between gap-3">
        ...
        <div class="relative">
          <button
            ...
            class="inline-flex items-center gap-2 rounded-lg sm:rounded-xl bg-gradient-to-r from-purple-600 to-purple-700 px-3 py-2 sm:px-4 sm:py-2.5 text-sm font-medium text-white shadow-lg transition-all duration-200 hover:from-purple-700 hover:to-purple-800 active:scale-95"
          >
            <Plus class="h-4 w-4" />
          ...
          >
            ...
            <div class="grid grid-cols-2 gap-2 mb-3">
              <button
                ...
                class="flex items-center gap-2 rounded-lg p-3 text-left text-sm transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-600"
              >
            ...
            <div class="border-t border-gray-200 pt-3 dark:border-gray-700">
              <button
                type="button"
                @click="addAttribute()"
                class="flex w-full items-center gap-2 rounded-lg p-3 text-sm text-gray-600 transition-colors hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 active:bg-gray-200 dark:active:bg-gray-600"
              >
                <Plus class="h-4 w-4" />
    ...
    <div class="space-y-3 sm:space-y-4">
      ...
      >
        ...
        <button
          ...
          class="absolute -right-1 -top-1 sm:-right-2 sm:-top-2 flex h-7 w-7 sm:h-8 sm:w-8 items-center justify-center rounded-full bg-red-500 text-white shadow-lg transition-all duration-200 hover:bg-red-600 active:scale-95"
        >
      ...
      <div v-if="modelValue.length === 0" class="rounded-lg sm:rounded-xl border-2 border-dashed border-gray-300 p-8 sm:p-12 text-center dark:border-gray-600">
        ...
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400 px-4">
          Ürününüzün özelliklerini ekleyin
        </p>
        <button
          type="button"
          @click="addAttribute()"
          class="mt-4 inline-flex items-center gap-2 rounded-lg bg-purple-600 px-4 py-3 text-sm font-medium text-white transition-colors hover:bg-purple-700 active:scale-95"
        >
          <Plus class="h-4 w-4" />
          İlk özelliği ekle
        </button>
      ...
      <div class="flex items-start gap-3">
        ...
        <div class="flex-1 min-w-0">
          ...
          <p class="mt-1 text-sm text-purple-700 dark:text-purple-300">
            Renk, boyut, materyal gibi temel özellikleri ekleyin.
          </p>
        </div>
      </div>
    </div>
