...
<template>
    <AppLayout :breadcrumbs="breadcrumbItems">
        ...
        <SettingsLayout>
            <div class="space-y-6">
                <HeadingSmall title="Şifreyi Güncelle" description="Hesabınızın güvenliği için güçlü ve benzersiz bir şifre kullanın." />
                ...
                <form @submit.prevent="updatePassword" class="space-y-6">
                    ...
                    <div class="flex items-center gap-4">
                        <Button :disabled="form.processing">Şifreyi Kaydet</Button>
